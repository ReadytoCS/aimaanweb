    ...
    <main className="max-w-4xl mx-auto px-4 py-10 flex flex-col gap-10">
      ...
      <section id="projects">
        <div className="projects-grid">
          ...
          <article id="consulting" className="project-card">
            ...
            <p className="text-sm italic mb-2">Strategy and fundraising advisory for nonprofits and retailers.</p>
            <div className="border-t border-gray-200 my-3" />
            <div className="mb-2">
              <div className="font-semibold mb-1">🛠️ What I Built</div>
              <ul className="text-base leading-relaxed list-disc">
          ...
          <article id="grainai" className="project-card">
            ...
            <p className="text-sm italic mb-2">Strategy, product design, and user research for a personal finance platform tailored to gig workers.</p>
            <div className="border-t border-gray-200 my-3" />
            <div className="mb-2">
              <div className="font-semibold mb-1">🛠️ What I Built</div>
              <ul className="text-base leading-relaxed list-disc">
          ...
          <article className="project-card">
            ...
            <p className="text-sm italic mb-2">Wrote articles on valuations, deal structures, and capital markets for a global finance audience.</p>
            <div className="border-t border-gray-200 my-3" />
            <div className="mb-2">
              <div className="font-semibold mb-1">🛠️ What I Built</div>
              <ul className="text-base leading-relaxed list-disc">
          ...
          <article id="gpt" className="project-card">
            ...
            <p className="text-sm italic mb-2">Built GPT-based tool to assist with early-stage investment research and memo drafting.</p>
            <div className="border-t border-gray-200 my-3" />
            <div className="mb-2">
              <div className="font-semibold mb-1">🛠️ What I Built</div>
              <ul className="text-base leading-relaxed list-disc">
          ...
          <article id="driver-dashboard" className="project-card">
            ...
            <p className="text-sm italic mb-2">Interactive dashboard analyzing Uber driver earnings after expenses across zones, times, and trip types.</p>
            <div className="border-t border-gray-200 my-3" />
            <div className="mb-2">
              <div className="font-semibold mb-1">🛠️ What I Built</div>
              <ul className="text-base leading-relaxed list-disc">
          ...
          <article id="research" className="project-card">
            ...
            <p className="text-sm italic mb-2">Research and policy analysis on low-emission energy solutions in emerging markets.</p>
            <div className="border-t border-gray-200 my-3" />
            <div className="mb-2">
              <div className="font-semibold mb-1">🛠️ What I Built</div>
              <ul className="text-base leading-relaxed list-disc">
